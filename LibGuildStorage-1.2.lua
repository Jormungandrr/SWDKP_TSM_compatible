...
SetGuildRosterShowOffline(SWDKP.db.profile.blizzard_show_offline)
...
GuildRosterShowOfflineButton:SetChecked(SWDKP.db.profile.blizzard_show_offline)
...
SWDKP.db.profile.blizzard_show_offline = GetGuildRosterShowOffline()
