local mod = SWDKP:NewModule("loot", "AceEvent-3.0")
...
mod.optionsName = "Loot"
mod.optionsDesc = "Automatic loot tracking"
mod.optionsArgs = {
  help = {
    order = 1,
    type = "description",
    name = "Automatic loot tracking by means of a popup to charge DKP to the toon that received loot. This option only has effect if you are in a raid and you are either the Raid Leader or the Master Looter."
  },
  threshold = {
    order = 10,
    type = "select",
    name = "Loot tracking threshold",
    desc = "Sets loot tracking threshold, to disable the popup on loot below this threshold quality.",
    values = {
